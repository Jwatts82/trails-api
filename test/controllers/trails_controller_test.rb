...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post trails_url, params: { trail: { difficulty: @trail.difficulty, miles: @trail.miles, name: @trail.name, park_id: @trail.park_id } }, as: :json
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { difficulty: @trail.difficulty, miles: @trail.miles, name: @trail.name, park_id: @trail.park_id } }, as: :json
    assert_response 200
  end
